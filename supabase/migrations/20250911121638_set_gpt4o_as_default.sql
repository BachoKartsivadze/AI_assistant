-- Set GPT-4o as the default model for new workspaces and update existing ones

-- Update existing workspaces to use GPT-4o as default model
UPDATE workspaces
SET default_model = 'gpt-4o'
WHERE default_model = 'gpt-4-turbo-preview';

-- Update the function that creates new workspaces to use GPT-4o as default
...
BEGIN
    ...
    VALUES(
        ...
        'Home',
        4096,
        'gpt-4o', -- Updated to use GPT-4o as default
